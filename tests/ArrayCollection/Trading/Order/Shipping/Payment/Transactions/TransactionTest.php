...
namespace Gpupo\CommonSchema\Tests\ArrayCollection\Trading\Order\Shipping\Payment\Transactions;
...
use Gpupo\CommonSchema\ArrayCollection\Trading\Order\Shipping\Payment\Transaction\Transaction;
use Gpupo\CommonSchema\ArrayCollection\Trading\Order\Shipping\Seller;
use Gpupo\CommonSchema\Tests\AbstractTestCase;
use Gpupo\CommonSdk\Traits\ResourcesTrait;

/**
 * @coversDefaultClass \Gpupo\CommonSchema\ArrayCollection\Trading\Order\Shipping\Payment\Transactions\Transaction
 */
class TransactionTest extends AbstractTestCase
{
    ...
    /**
     * @return \Gpupo\CommonSchema\ArrayCollection\Trading\Order\Shipping\Payment\Transactions\Transaction
     */
