 ...
 * AlternativePhone.
 *
 * @ORM\Table(schema="public", name="cs_organization_company_alternative_phone")
 * @ORM\Entity(repositoryClass="Gpupo\CommonSchema\ORM\EntityRepository\Organization\AlternativePhoneRepository")
 */
