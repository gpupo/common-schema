 ...
 * @ORM\Entity(repositoryClass="Gpupo\CommonSchema\ORM\Repository\Trading\Order\Shipping\ConciliationRepository")
 */
class Conciliation extends \Gpupo\CommonSchema\AbstractORMEntity
{
     ...
     *
     * @ORM\OneToOne(targetEntity="Gpupo\CommonSchema\ORM\Entity\Trading\Order\Shipping\Shipping", inversedBy="conciliation")
     * @ORM\JoinColumns({
